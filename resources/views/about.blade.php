...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18]">
            ...
            <div class="lg:w-1/2 w-full" id="about-desc">
                <div class="px-5 py-5 flex flex-col justify-center">
                    ...
                    <p class="text-base text-tertiary mb-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                        Facere
                        voluptates animi doloremque beatae natus, repudiandae quibusdam, placeat sequi autem totam vel
                    ...
                    <ul class="links flex justify-baseline items-center gap-5">
                        <li><a href="https://www.instagram.com/olivvard"
                                class="text-tertiary md:text-2xl text-lg hover:text-purple-400 transition-all duration-300" target="_blank"><i
                                    class="fa-brands fa-instagram"></i> Olivvard</a></li>
                        <li><a href="https://www.youtube.com/@Olivvard"
                                class="text-tertiary md:text-2xl text-lg hover:text-red-400 transition-all duration-300" target="_blank"><i
                                    class="fa-brands fa-youtube"></i> Olivvard</a></li>
                        <li><a href="https://www.linkedin.com/in/rahmat-rivaldo-245825292/"
                                class="text-tertiary md:text-2xl text-lg hover:text-blue-400 transition-all duration-300" target="_blank"><i
                                    class="fa-brands fa-linkedin"></i> Rahmat Rivaldo</a></li>
                        <li><a href="https://www.behance.net/rahmatrivaldo"
                                class="text-tertiary md:text-2xl text-lg hover:text-gray-500 transition-all duration-300" target="_blank"><i
                                    class="fa-brands fa-behance"></i> Olivvard</a></li>
                    </ul>
                </div>
            </div>
    ...
    <footer class="text-tertiary">
        <div class="flex justify-center items-center py-12 px-32">
            ...
            <span class="text-dark text-opacity-75 mx-1" style="font-size: 0.2em;"><i
